...
2. Under **Assets**, download `thinkpage-bridge-v1.6.0.xpi`.
...
5. Select the downloaded `thinkpage-bridge-v1.6.0.xpi` file and click **Add**.

### **Method 2: Install via `.zip` Package**

1. Go to the **[Releases Page](https://github.com/naitiktuxx/ThinkPage-Bridge-Extension/releases)** and download `thinkpage-bridge-v1.6.0.zip`.
...
```bash
cd src && zip -r ../dist/thinkpage-bridge-v1.6.0.zip *
cd .. && cp dist/thinkpage-bridge-v1.6.0.zip dist/thinkpage-bridge-v1.6.0.xpi
```
